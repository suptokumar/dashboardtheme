...
<header style="overflow: hidden;">
    ...
    <a href="{{ url('/admin/withdralid') }}" class="btn btn-info float-left">ID Withdrawal List</a>

</header>
<section class="gateway_view">
  <form action="{{ url('/admin/createapi/addidwithdrawalrequest') }}" method="POST" enctype="multipart/form-data">
 ...
 --}}
  ...
  <div class="cpnel">
   <label for="info">Info <span class="red">*</span></label>
    <textarea id="info" name="info" placeholder="Please put valid account information" class="form-control"></textarea>
  </div>
  <br>
