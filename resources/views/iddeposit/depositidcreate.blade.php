...
<header style="overflow: hidden;">
    ...
    <a href="{{ url('/admin/depositid') }}" class="btn btn-info float-left">ID Deposit List</a>

</header>
<section class="gateway_view">
  <form action="{{ url('/admin/createapi/adddepositid') }}" method="POST" enctype="multipart/form-data">
...
{{--    <div class="form-group col-md-6">
 ...
 --}}
  ...
  <button type="submit" class="btn btn-primary">Create Id Deposit</button>
  </div>
</form>
</section>
</article>
